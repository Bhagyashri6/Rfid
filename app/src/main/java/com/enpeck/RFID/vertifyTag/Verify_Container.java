...
import com.enpeck.RFID.common.SampleTableAdapterVertifycontainer;
 ...
 */
public class Verify_Container extends Fragment {
    ...
    private String[] tableHeaders={"IEC Code","Shipping Bill No","Shipping Bill Date","e-Seal No","Date of Sealing","Time of Sealing","Destination Port","Container No","Truck No","Latitude","Longitude","Verified","Count"};
  ...
  private static final String NAMESPACE = "http://tempuri.org/";
    ...
    private static final String Soap_ACTIONAll = "http://tempuri.org/GetVerifyContainerAll";
    // specifies the action
    private static final String METHOD_NAMEAll = "GetVerifyContainerAll";
    ...
    public Verify_Container() {
        // Required empty public constructor
    }

    public static Verify_Container newInstance() {
        return new Verify_Container();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_verify__container, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                listReport.clear();
                new asynvertifieddata(bill,iec,getData).execute();
            }
        });
    }
    ...
    public class MyAdapter extends SampleTableAdapterVertifycontainer {
    ...
    public class asynvertifieddata extends AsyncTask<Void,Void,Void>{
        ProgressDialog pd =new ProgressDialog(getActivity());
        String billl,iec,Date,contt;

        int flag =0;

        public asynvertifieddata(String billl,String iec,String Date ) {
            this.billl = billl;
            this.iec =iec;
            this.Date =Date;
