 ...
 * @author Brais Gabín
 */
public abstract class SampleTableAdapterTagDetail extends BaseTableAdapter {
     ...
     */
    public SampleTableAdapterTagDetail(Context context) {
   ...
   /* private void setText(View view, String text,int r,int c) {
        ...
        if(r==0&&c==-1)
        {
            ((TextView) view.findViewById(android.R.id.text1)).setBackgroundColor(Color.RED);
